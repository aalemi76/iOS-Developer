...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let track_left_resizable = track_left_image.resizableImage(withCapInsets: insets, resizingMode: .stretch)
        slider.setMinimumTrackImage(track_left_resizable, for: .normal)
        let track_right_image = #imageLiteral(resourceName: "SmallButton")
        let track_right_resizable = track_right_image.resizableImage(withCapInsets: insets, resizingMode: .stretch)
